...
db.Compare = db.conn.define('compare', {
	date: 						sequelize.STRING,
	compare_temp_day: 			sequelize.BOOLEAN,
	compare_temp_night: 		sequelize.BOOLEAN,
	compare_wind_direction: 	sequelize.BOOLEAN,
	compare_wind_speed: 		sequelize.BOOLEAN
})
